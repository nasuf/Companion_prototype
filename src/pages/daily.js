...
function dailyContent(tab){
  ...
  if(tab.id==="food"){
    const dishes=[
      ["番茄牛腩饭","番茄炒出沙，牛腩小火收汁，最后浇在热米饭上。适合记录成“今天把自己喂好了”。","步骤：煎香洋葱 / 加番茄和牛腩 / 小火 28 分钟 / 收汁",`url('assets/prototype/remote/unsplash-1546069901-ba9599a7e63c.jpg')`],
      ["桂花拿铁","咖啡味轻，桂花香明显，适合下午困的时候。分享时可以带一句“今天被一杯甜的救了一下”。","配方：浓缩咖啡 / 牛奶 / 桂花蜜 / 少冰",`url('assets/prototype/remote/unsplash-1509042239860-f550ce710b93.jpg')`],
      ["清爽拌面","不重油，适合晚上不想点外卖时的轻食。可以生成一张菜谱卡。","步骤：煮面 6 分钟 / 过冷水 / 加黄瓜丝和酱汁",`url('assets/prototype/remote/unsplash-1512621776951-a57141f2eefd-2.jpg')`],
      ["莓果酸奶碗","蓝莓和坚果铺在酸奶上，适合作为早晨第一张轻分享。","步骤：酸奶打底 / 加莓果 / 撒燕麦和坚果 / 淋蜂蜜",`url('assets/prototype/remote/unsplash-1488477181946-6428a0291777.jpg')`],
      ["周末烤吐司","黄油边缘烤到微焦，适合配一句“今天慢一点”。","步骤：厚切吐司 / 抹黄油 / 烤 6 分钟 / 加果酱",`url('assets/prototype/remote/unsplash-1484723091739-30a097e8f929.jpg')`]
    ];
  ...
  const groups=[
    ["傍晚光线","适合一句很短的晚安。","7 张",["url('assets/prototype/remote/unsplash-1500530855697-b586d89ba3ee-2.jpg')","url('assets/prototype/remote/unsplash-1500534314209-a25ddb2bd429.jpg')","url('assets/prototype/remote/unsplash-1493246507139-91e8fad9978e.jpg')","url('assets/prototype/remote/unsplash-1506744038136-46273834b3fb.jpg')","url('assets/prototype/remote/unsplash-1470770841072-f978cf4d019e.jpg')"]],
    ["桌面碎片","咖啡、书页、拍立得和没收好的耳机。","12 张",["url('assets/prototype/daily-journal.jpg')","url('assets/prototype/remote/unsplash-1499750310107-5fef28a66643.jpg')","url('assets/prototype/remote/unsplash-1516321318423-f06f85e504b3.jpg')","url('assets/prototype/remote/unsplash-1515378791036-0648a3ef77b2.jpg')","url('assets/prototype/remote/unsplash-1518005020951-eccb494ad742.jpg')"]],
    ["路上看到","可以整理成一张“今天经过这里”的卡。","5 张",["url('assets/prototype/remote/unsplash-1519681393784-d120267933ba.jpg')","url('assets/prototype/remote/unsplash-1481277542470-605612bd2d61.jpg')","url('assets/prototype/remote/unsplash-1477959858617-67f85cf4f1df.jpg')","url('assets/prototype/remote/unsplash-1500534314209-a25ddb2bd429.jpg')","url('assets/prototype/remote/unsplash-1511818966892-d7d671e672a2.jpg')"]],
    ["小物件","不用解释也能知道今天怎么过的。","8 张",["url('assets/prototype/remote/unsplash-1515879218367-8466d910aaa4.jpg')","url('assets/prototype/remote/unsplash-1513519245088-0e12902e5a38.jpg')","url('assets/prototype/remote/unsplash-1484480974693-6ca0a78fb36b.jpg')","url('assets/prototype/remote/unsplash-1516035069371-29a1b244cc32.jpg')"]]
  ];
...
function daily(){const tabs=[
  {id:"photo",label:"照片",accent:"#1f6fff",accent2:"#18c6c0",glow:"rgba(31,111,255,.20)",soft:"rgba(31,111,255,.18)",image:"url('assets/prototype/remote/unsplash-1500530855697-b586d89ba3ee.jpg')",kicker:"photo diary",title:"把照片整理成一句自然分享",desc:"照片分享不需要长文案，保留画面、时间和一句像朋友会说的话就够了。",chip:"32 张照片"},
